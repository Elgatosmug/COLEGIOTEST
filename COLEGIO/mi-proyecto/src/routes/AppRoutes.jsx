...
import AdminPanel from "../components/publicaciones/AdminPanel";
import { PostsList } from "../components/publicaciones/PostsList";
import { PostDetail } from "../components/publicaciones/PostDetail";
...
function AppRoutes() { 
  ...
  return ( 
    <Routes> 
      ...
      {/* Ruta para ver todas las publicaciones (vista de usuario) */}
      <Route
        path="/publicaciones"
        element={<PostsList />}
      />
      
      {/* Ruta para ver detalle de una publicación */}
      <Route
        path="/post/:postId"
        element={<PostDetail />}
      />
