                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-white rounded-lg shadow-lg p-8">
                        <div className="flex justify-center items-center gap-6">
                            ...
                            <button 
                                className="bg-red-500 text-white px-8 py-4 rounded-lg hover:bg-red-600 transition-colors text-lg font-semibold"
    ...
    return (
        <div className="p-6">
            ...
            <div className='flex gap-4 mb-6'>
                <button onClick={handleAddDeporte} className='border px-5 py-2 rounded-lg bg-blue-500 text-white hover:bg-white hover:text-blue-500 transition-colors'>
                ...
                <button 
                    className='border px-5 py-2 rounded-lg bg-red-500 text-white hover:bg-white hover:text-red-500 transition-colors'
